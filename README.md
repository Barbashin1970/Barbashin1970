...
В IT я с 2022 года, начал с тестирования и системного анализа. Несколько лет я гонял тесты и писал спеки по ГОСТ 19.
Недавно начал применять ИИ для разработки ПО по Spec&Test-Driven-Development.
Сначала это были простые игры, а сейчас я уже проектирую сложные информационные системы.
